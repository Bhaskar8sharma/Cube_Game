...
function setupCameraAndLight() {
    ...
    let hemiSphereLight = new THREE.HemisphereLight(0xffffff, 0x00ff00, 0.25);//skycolor, groundcolor, intensity  
...
function createGeometry() {
    ...
    let planeGeom = new THREE.PlaneGeometry(50, 60);
    let planeMat =  Physijs.createMaterial(new THREE.MeshStandardMaterial({ color: 0xffffff,
        map: new THREE.TextureLoader().load('assets/textures/grasslight-big.jpg'),
         transparent: true }),0.3,0.7)
...
function createTable()
{
    tableTop = new Physijs.BoxMesh(
        new THREE.BoxGeometry(15,1.5,20),
        Physijs.createMaterial(new THREE.MeshStandardMaterial({color: 0x765c48, 
            map: new THREE.TextureLoader().load('assets/textures/floor-wood.jpg')}))
        );
...
function setupDatGui() {
    ...
    controls = new function() {
        this.Bhaskar1 = function(){readFile(3000,"Bhaskar1");}
        this.Bhaskar2 = function(){readFile(3000,"Bhaskar2");}
        this.Bhaskar3 = function(){readFile(3000,"Bhaskar3");}
        this.Bhaskar4 = function(){readFile(3000,"Bhaskar4");}
        this.Bhaskar5 = function(){readFile(3000,"Bhaskar5");}
        this.reset = function()
        {
            resetGame();
        }
    ...
    let gui = new dat.GUI();
    gui.add(controls, "Bhaskar1").name("Level 1");
    gui.add(controls, "Bhaskar2").name("Level 2");
    gui.add(controls, "Bhaskar3").name("Level 3");
    gui.add(controls, "Bhaskar4").name("Level 4");
    gui.add(controls, "Bhaskar5").name("Level 5");
